          ...
          <div class="row vertical-content justify-content-center">
              ...
              <div class="col-lg-4 offset-lg-2">
                  <div class="card mx-auto p-4 rounded mt-5 mt-lg-0">
                      ...
                      <form class="registration-form" id="myForm" action="{{ route('create') }}" method="POST" >
                        @csrf
                          <div class="form-group mb-4">
                              <label class=" font-15 sr-only @error('name') is-invalid @enderror">Nome Completo:*</label>
                          ...
                          <button type="submit" class="btn btn-primary btn-block btn-sm">Cadastrar-se <i class="mdi mdi-arrow-right ml-2"></i></button>
                      </form> 
